  ...
  return (
    <div className="flex flex-col min-h-screen bg-teal-950">
      <div className="bg-slate-100 py-4">
        <ul className="flex justify-center"></ul>
      </div>
      <div className="flex flex-grow justify-center items-center flex-col">
        <h1 className="text-6xl text-white mt-12 mb-8 font-bold">Welcome! </h1>

        <h3 className="text-white text-center mb-10 font-bold">
          This is a web app interface that allows monitoring of refrigerating
          loads{" "}
        </h3>
